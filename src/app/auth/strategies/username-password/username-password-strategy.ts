...
import { AuthIllegalTokenError } from '../../models/auth-token';
import { UsernamePasswordAuthStrategyOptions, passwordStrategyOptions } from './username-password-options';
...
export class UsernamePasswordAuthStrategy extends AuthStrategy {
    ...
    protected defaultOptions: UsernamePasswordAuthStrategyOptions = passwordStrategyOptions;

    static setup(options: UsernamePasswordAuthStrategyOptions): [AuthStrategyClass, UsernamePasswordAuthStrategyOptions] {
        return [UsernamePasswordAuthStrategy, options];
    }
